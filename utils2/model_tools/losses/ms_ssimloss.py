...
def ms_ssim(
    ...
    """Return the MS-SSIM between :math:`x` and :math:`y`.
    ...
    for i in range(m):
        ...
        ss, cs = ssim_index(x, y, kernel, channel_avg=False, val_range=val_range, nonnegative=nonnegative)
...
class SSIMLoss(nn.Module):
    """Label SIMM Loss for segmentation.
    ...
    Shape:
        - Input (Tensor): :math:`(B, num_classes, H, W)`, predicted probability maps
