...
FOLDERS = ["config","data","data/raw","data/processed","data/splits","models", \
    "models/trained_models", "notebooks","results","results/images","results/statistics", \
        "src","utils","visualization"]
FILES = ["src/__init__.py","utils/__init__.py", "models/model_config.json", "data/__init__.py", \
    "data/data_info.csv", "results/results.csv", "models/__init__.py", "visualization/__init__.py", \
        "src/training_config.json", "notebooks/prototype_tests.ipynb", "config/config.json", \
