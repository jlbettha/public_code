# RESNET model from scratch (w/ re-usable model_config module) from: https://github.com/christianversloot/machine-learning-articles/blob/main/how-to-build-a-resnet-from-scratch-with-tensorflow-2-and-keras.md
...
def model_configuration():
    ...
    epochs = tf.cast(
        tf.math.floor(maximum_number_iterations / steps_per_epoch),
        dtype=tf.int64,
    )
    ...
    checkpoint = ModelCheckpoint(
        os.path.join(os.getcwd(), "model_checkpoint"), save_freq="epoch"
    )
...
def preprocessed_dataset():
    ...
    test_batches = test_generator.flow(
        input_test, target_test, batch_size=config.get("batch_size")
    )
