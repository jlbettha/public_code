...
def lstm_classification(input_tensor, n_classes, *, n_nodes=64, bidirectional=False, return_sequences=False):
    """
    ...
    """
    lstm_model = LSTM(n_nodes, input_shape=input_tensor.shape, return_sequences=return_sequences)(input_tensor)

    # Birdirectional LSTM
    if bidirectional:
        model_backwards = LSTM(n_nodes, return_sequences=return_sequences, go_backwards=True)(input_tensor)
...
def lstm_regression(input_tensor, *, n_nodes=64, bidirectional=False, return_sequences=False):
    """
